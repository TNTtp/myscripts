				...
				if tArea then
					...
					for i, v in partParts do
						...
						if mirror == true then
							...
							CF = (CFrame.new(Pos) * CFrame.Angles(math.rad(v.CFrame.Rotation.X), math.rad(v.CFrame.Rotation.Y), math.rad(v.CFrame.Rotation.Z))) * CFrame.Angles(math.rad(180), 0, 0)
						else
							Pos = mySpawn.Position - (tSpawn.Position - v.Position)
							CF = CFrame.new(Pos) * CFrame.Angles(math.rad(v.CFrame.Rotation.X), math.rad(v.CFrame.Rotation.Y), math.rad(v.CFrame.Rotation.Z))
						end
